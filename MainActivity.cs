...
namespace MultiFuncApp
{
    ...
    // IF A CHANGE IS REGISTERED HERE THEN THIS VERSION IS UP TO DATE
    ...
    public class MainActivity : Activity
    {
        ...
        // variabes for our speech to text function
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            // SPEECH-TO-TEXT
            // prompts whether user can record or not 
            isRecording = false;
            SetContentView(Resource.Layout.Main);

            recButton = FindViewById<Button>(Resource.Id.recordButton);
            textBox = FindViewById<TextView>(Resource.Id.textInput);

            // checks to see if user has microphone
            string rec = Android.Content.PM.PackageManager.FeatureMicrophone;
            if (rec != "android.hardware.microphone")
            {
                // prompts alert if microphone is not found
                ...
                {
                    recButton.Text = "End voice recording";
