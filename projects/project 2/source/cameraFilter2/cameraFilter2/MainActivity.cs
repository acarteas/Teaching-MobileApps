    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            ...
            */
            ...
            Button redRemoval = FindViewById<Button>(Resource.Id.redRemoval);
            Button greenRemoval = FindViewById<Button>(Resource.Id.greenRemoval);
            Button blueRemoval = FindViewById<Button>(Resource.Id.blueRemoval);
            Button negativeCheck = FindViewById<Button>(Resource.Id.negative);
            Button turnGrey = FindViewById<Button>(Resource.Id.greyScale);

            redRemoval.Click += delegate
            {
